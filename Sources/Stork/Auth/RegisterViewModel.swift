...
//    
//    @MainActor
//    func registerWithEmail(profile: Profile) async throws -> Profile {
...
//        
//        do {
//            updatedProfile = try await profileRepository.registerWithEmail(profile: profile, password: self.passwordText)
