...
//
//  Shared card chrome: titled, accent-tinted, glassy container for a dashboard statistic.
//
        ...
        .background(
            ZStack {
                ...
                RoundedRectangle(cornerRadius: 16, style: .continuous)
                    .fill(LinearGradient(colors: [accent.opacity(0.14), .clear], startPoint: .topLeading, endPoint: .bottomTrailing))
            }
        )
