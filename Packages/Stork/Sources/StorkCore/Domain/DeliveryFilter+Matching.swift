...
//  StorkCore
//
//  Whether a delivery passes a filter, and whether a filter is a no-op. Touches the
//  `@Model` types, so it runs on the MainActor like the rest of the SwiftData surface.
//

import Foundation

public extension DeliveryFilter {
